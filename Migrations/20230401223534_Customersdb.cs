        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetName = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false),
                    HouseNumber = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    City = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    PostalCode = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false),
                    Country = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
